...
import ui.diseno.software.views.modals.AgregarProductos;
 ...
 * @author Gabriel
 */
public class FormProductos extends TabbedForm {

    private ProductoServicio service = new ProductoServicio();
    ...
    private void initComponents() {
        ...
        table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "SELECCIONAR", "#", "NOMBRE", "DESCRIPCION", "MODELO", "PRECIO", "COSTO", "STOCK", "FECHA CREACION PRODUCTO", "MARCA", "CATEGORIA"
            }
        ) {
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
        ...
        if (!list.isEmpty()) {
            ...
            if (list.size() == 1) {
                ...
                Producto data = list.get(0);
                AgregarProductos create = new AgregarProductos();
                ...
                GlassPanePopup.showPopup(new SimplePopupBorder(create, "Editar Producto [" + data.getNombreProducto()+ "]", action, (pc, i) -> {
                    if (i == 1) {
                        // edit data

                        try {
                            Producto dataEdit = create.getData();
                            dataEdit.setProductoId(data.getProductoId());
                            service.edit(dataEdit);
                            pc.closePopup();
                            Notifications.getInstance().show(Notifications.Type.SUCCESS, "El producto fue actualizado con éxito");
                ...
                Notifications.getInstance().show(Notifications.Type.WARNING, "Por favor selecciona solamente 1 producto");
            }

        } else {
            Notifications.getInstance().show(Notifications.Type.WARNING, "Debes seleccionar 1 producto");
        }
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        if (!list.isEmpty()) {
            ...
            JLabel label = new JLabel("¿Estas seguro que deseas eliminar " + list.size() + " producto?");
            ...
            GlassPanePopup.showPopup(new SimplePopupBorder(label, "Confirmar cambios", action, (pc, i) -> {
                if (i == 1) {
                    ...
                    try {
                        for (Producto d : list) {
                            service.delete(d.getProductoId());
                        }
                        pc.closePopup();
                        Notifications.getInstance().show(Notifications.Type.SUCCESS, "Producto eliminado con éxito");
            ...
            Notifications.getInstance().show(Notifications.Type.WARNING, "Por favor, selecciona un producto para eliminar");
    ...
    private void btnCrearActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCrearActionPerformed
        ...
        GlassPanePopup.showPopup(new SimplePopupBorder(create, "Crear nuevo producto", action, (pc, i) -> {
            if (i == 1) {
                // save data
                ...
                try {
                    ...
                    pc.closePopup();
                    Notifications.getInstance().show(Notifications.Type.SUCCESS, "El producto fue creado con éxito");
    ...
    private List<Producto> getSelectedData() {
        ...
        for (int i = 0; i < table.getRowCount(); i++) {
            if ((boolean) table.getValueAt(i, 0)) {
                Producto data = (Producto) table.getValueAt(i, 2);
                list.add(data);
            }
        }
