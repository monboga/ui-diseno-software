...
import ui.diseno.software.views.modals.AgregarMarca;
 ...
 * @author Gabriel
 */
public class FormMarcas extends TabbedForm {

    MarcaServicio service = new MarcaServicio();
    ...
    private void loadData() {
        try {
            ...
            model.setRowCount(0);
            List<Marca> list = service.getAll();
            for (Marca d : list) {
    ...
    private void initComponents() {
        ...
        table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "SELECCIONAR", "#", "MARCA", "FECHA CREACION MARCA"
            }
        ) {
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
        // TODO add your handling code here:
        List<Marca> list = getSelectedData();
        if (!list.isEmpty()) {

            if (list.size() == 1) {

                Marca data = list.get(0);
                AgregarMarca create = new AgregarMarca();
                ...
                GlassPanePopup.showPopup(new SimplePopupBorder(create, "Editar Marca [" + data.getNombreMarca()+ "]", action, (pc, i) -> {
                    if (i == 1) {
                        // edit data

                        try {
                            Marca dataEdit = create.getData();
                            dataEdit.setMarcaId(data.getMarcaId());
                            service.edit(dataEdit);
                            pc.closePopup();
                            Notifications.getInstance().show(Notifications.Type.SUCCESS, "La marca fue actualizada con éxito");
                ...
                Notifications.getInstance().show(Notifications.Type.WARNING, "Por favor selecciona solamente 1 marca");
            }

        } else {
            Notifications.getInstance().show(Notifications.Type.WARNING, "Debes seleccionar 1 marca");
        }
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        if (!list.isEmpty()) {
            ...
            JLabel label = new JLabel("¿Estas seguro que deseas eliminar " + list.size() + " marca?");
            ...
            GlassPanePopup.showPopup(new SimplePopupBorder(label, "Confirmar cambios", action, (pc, i) -> {
                if (i == 1) {
                    ...
                    try {
                        for (Marca d : list) {
                            service.delete(d.getMarcaId());
                        }
                        pc.closePopup();
                        Notifications.getInstance().show(Notifications.Type.SUCCESS, "Marca eliminada con éxito");
            ...
            Notifications.getInstance().show(Notifications.Type.WARNING, "Por favor, selecciona una marca para eliminar");
    ...
    private void btnCrearActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCrearActionPerformed
        ...
        GlassPanePopup.showPopup(new SimplePopupBorder(create, "Crear nueva marca", action, (pc, i) -> {
            if (i == 1) {
                // save data
                ...
                try {
                    ...
                    pc.closePopup();
                    Notifications.getInstance().show(Notifications.Type.SUCCESS, "La marca fue creada con éxito");
    ...
    private List<Marca> getSelectedData() {
        List<Marca> list = new ArrayList<>();

        for (int i = 0; i < table.getRowCount(); i++) {
            if ((boolean) table.getValueAt(i, 0)) {
                Marca data = (Marca) table.getValueAt(i, 2);
                list.add(data);
            }
        }
