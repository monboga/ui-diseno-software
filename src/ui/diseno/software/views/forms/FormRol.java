...
import ui.diseno.software.views.modals.AgregarRol;
 ...
 * @author Gabriel
 */
public class FormRol extends TabbedForm {

    private RolServicio service = new RolServicio();
    ...
    private void initComponents() {
        ...
        table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "SELECCIONAR", "#", "NOMBRE", "FECHA CREACION ROL"
            }
        ) {
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
        // TODO add your handling code here:
        List<Rol> list = getSelectedData();
        if (!list.isEmpty()) {

            if (list.size() == 1) {

                Rol data = list.get(0);
                AgregarRol create = new AgregarRol();
                ...
                GlassPanePopup.showPopup(new SimplePopupBorder(create, "Editar Rol [" + data.getNombreRol() + "]", action, (pc, i) -> {
                    if (i == 1) {
                        // edit data

                        try {
                            Rol dataEdit = create.getData();
                            dataEdit.setRolId(data.getRolId());
                            service.edit(dataEdit);
                            pc.closePopup();
                            Notifications.getInstance().show(Notifications.Type.SUCCESS, "El Rol fue actualizado con éxito");
                ...
                Notifications.getInstance().show(Notifications.Type.WARNING, "Por favor selecciona solamente 1 rol");
            }

        } else {
            Notifications.getInstance().show(Notifications.Type.WARNING, "Debes seleccionar 1 rol");
        }
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        if (!list.isEmpty()) {
            ...
            JLabel label = new JLabel("¿Estas seguro que deseas eliminar " + list.size() + " rol?");
            ...
            GlassPanePopup.showPopup(new SimplePopupBorder(label, "Confirmar cambios", action, (pc, i) -> {
                if (i == 1) {
                    ...
                    try {
                        for (Rol d : list) {
                            service.delete(d.getRolId());
                        }
                        pc.closePopup();
                        Notifications.getInstance().show(Notifications.Type.SUCCESS, "Rol eliminado con éxito");
            ...
            Notifications.getInstance().show(Notifications.Type.WARNING, "Por favor, selecciona un rol para eliminar");
    ...
    private void btnCrearActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCrearActionPerformed
        ...
        GlassPanePopup.showPopup(new SimplePopupBorder(create, "Crear nuevo rol", action, (pc, i) -> {
            if (i == 1) {
                // save data
                ...
                try {
                    ...
                    pc.closePopup();
                    Notifications.getInstance().show(Notifications.Type.SUCCESS, "El rol fue creado con éxito");
    ...
    private List<Rol> getSelectedData() {
        List<Rol> list = new ArrayList<>();

        for (int i = 0; i < table.getRowCount(); i++) {
            if ((boolean) table.getValueAt(i, 0)) {
                Rol data = (Rol) table.getValueAt(i, 2);
                list.add(data);
            }
        }
