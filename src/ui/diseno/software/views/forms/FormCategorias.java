...
import ui.diseno.software.services.CategoriaServicio;
import ui.diseno.software.views.modals.AgregarCategorias;
 ...
 * @author Gabriel
 */
public class FormCategorias extends TabbedForm {

    CategoriaServicio service = new CategoriaServicio();
    ...
    private void initComponents() {
        ...
        table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "SELECCIONAR", "#", "CATEGORIA", "FECHA CREACION CATEGORIA"
            }
        ) {
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
        // TODO add your handling code here:
        List<Categoria> list = getSelectedData();
        if (!list.isEmpty()) {

            if (list.size() == 1) {

                Categoria data = list.get(0);
                AgregarCategorias create = new AgregarCategorias();
                ...
                GlassPanePopup.showPopup(new SimplePopupBorder(create, "Editar Categoria [" + data.getNombreCategoria()+ "]", action, (pc, i) -> {
                    if (i == 1) {
                        // edit data

                        try {
                            Categoria dataEdit = create.getData();
                            dataEdit.setCategoriaId(data.getCategoriaId());
                            service.edit(dataEdit);
                            pc.closePopup();
                            Notifications.getInstance().show(Notifications.Type.SUCCESS, "La categoría fue actualizada con éxito");
                ...
                Notifications.getInstance().show(Notifications.Type.WARNING, "Por favor selecciona solamente 1 categoría");
            }

        } else {
            Notifications.getInstance().show(Notifications.Type.WARNING, "Debes seleccionar 1 categoría");
        }
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        if (!list.isEmpty()) {
            ...
            JLabel label = new JLabel("¿Estas seguro que deseas eliminar " + list.size() + " categoria?");
            ...
            GlassPanePopup.showPopup(new SimplePopupBorder(label, "Confirmar cambios", action, (pc, i) -> {
                if (i == 1) {
                    ...
                    try {
                        for (Categoria d : list) {
                            service.delete(d.getCategoriaId());
                        }
                        pc.closePopup();
                        Notifications.getInstance().show(Notifications.Type.SUCCESS, "Categoría eliminada con éxito");
            ...
            Notifications.getInstance().show(Notifications.Type.WARNING, "Por favor, selecciona una categoría para eliminar");
    ...
    private void btnCrearActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCrearActionPerformed
        ...
        GlassPanePopup.showPopup(new SimplePopupBorder(create, "Crear nueva categoria", action, (pc, i) -> {
            if (i == 1) {
                // save data
                ...
                try {
                    ...
                    pc.closePopup();
                    Notifications.getInstance().show(Notifications.Type.SUCCESS, "La categoria fue creada con éxito");
    ...
    private List<Categoria> getSelectedData() {
        List<Categoria> list = new ArrayList<>();

        for (int i = 0; i < table.getRowCount(); i++) {
            if ((boolean) table.getValueAt(i, 0)) {
                Categoria data = (Categoria) table.getValueAt(i, 2);
                list.add(data);
            }
        }
